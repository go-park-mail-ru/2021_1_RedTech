...
var movieTestData = map[uint]domain.Movie{
	1: {
		...
		Actors:      []*domain.Actor{{ID: 1, FirstName: "Sono"}, {ID: 3, FirstName: "Chi"}},
	...
	2: {
		...
		IsFree:      true,
		Genres:      []string{"Comedy"},
		Actors:      []*domain.Actor{{ID: 1, FirstName: "John", LastName: "Wick"}},
		Avatar:      "/static/movies/default.jpg",
		Type:        domain.MovieT,
		Year:        "1999",
	...
	3: {
		...
		Actors:      []*domain.Actor{{ID: 1, FirstName: "Actor1"}, {ID: 2, FirstName: "Actor2"}},
		Avatar:      "/static/movies/default.jpg",
		Type:        domain.MovieT,
		Year:        "3000",
	...
	4: {
		...
		Actors:      []*domain.Actor{{ID: 1, FirstName: "Ivan"}, {ID: 3, FirstName: "Nikolay"}},
		Avatar:      "/static/movies/default.jpg",
		Type:        domain.SeriesT,
		Year:        "3000",
...
var movieSetFavouriteTests = []movieSetFavouriteTestCase{
	...
	{
		inURL:       "/api/media/movie/1/favourites?action=delete",
	...
	{
		inURL:       "/api/media/movie/2/favourites?action=save",
		inRouteName: addFavourite,
		inParams:    map[string]string{"id": "2"},
	...
	{
		inURL:       "/api/media/movie/3/favourites?action=delete",
		inRouteName: removeFavourite,
